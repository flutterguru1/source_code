...
class NikeShoesShop extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
   return  const MaterialApp(
     ...
     home: NikeShoesHome(title: "Nike shoe Shop",),
   );
  }
}
...
class _NikeShoesHomeState  extends State<NikeShoesHome>{
  ...
  void initState() {
   ...
   _products.add(Product(url:"assets/products/blue1.png" ,primaryColor: const Color(0xff0000ff)));
   _products.add(Product(url: "assets/products/black1.png", primaryColor: const Color(0xffde304a)));
   _products.add(Product(url: "assets/products/grey1.png", primaryColor: const Color(0xff8e8b89)));
   ...
   //active product
   _activeProduct = _products.elementAt(_activeProductIndex);
    super.initState();
  }
  @override
  void dispose() {
        ...
        child: PageView.builder(
          ...
          onPageChanged: (int index) {
            setState(() {
              ...
              _activeProduct = _products.elementAt(index);
            });
          },
          itemBuilder: (context, index) {
            return _activeProductIndex == index ? _activeProductItem(index): _productItem(index);
          },
        ),
      ),
    );
        ...
        children: [
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("AIR JORDAN 1 MID SE GC", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22,letterSpacing: -2),),
            ...
            child: Container(
             // color: Colors.blue,
              ...
              child: Transform.rotate(angle: -math.pi/6,
                child: Image.asset(_products.elementAt(index).url),
              ),
            ),
          ),
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: const BorderRadius.only(topLeft: Radius.circular(50), bottomRight: Radius.circular(50)),
                        color: _products.elementAt(index).primaryColor,
